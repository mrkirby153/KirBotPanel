                        ...
                        <div className="form-row">
                            <div className="col-6">
                                <Field help="The amount of users that have to join">
                                    ...
                                    <input type="number" className="form-control" name="anti_raid_count"
                                           id="anti_raid_count"
                            ...
                            <div className="col-6">
                                <Field help="The period (in seconds) over which the users have to join">
                                    ...
                                    <input type="number" className="form-control" name="anti_raid_period"
                                           id="anti_raid_period"
                        ...
                        <div className="form-row">
                            <div className="col-6">
                                <Field help="The action to apply to users who join during an ongoing raid">
                                    ...
                                    <select name="anti_raid_action" className="form-control"
                            ...
                            <div className="col-6">
                                <Field
                                    ...
                                    <input type="number" className="form-control" name="anti_raid_quiet_period"
